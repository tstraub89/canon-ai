...
- [ ] **Handoff Validation Outcomes Check column format mismatch causes false pre-flight failures** *(surfaced 2026-05-11 during `prompt-fidelity-tests` pipeline run; prior instance in `fix-pipeline-bugs`)*
...
- [ ] **Prompt-fidelity regression coverage — rebuild from scratch** *(originally surfaced 2026-05-09; reframed 2026-05-11 after the test files were deleted from dev)*
