# Implementation Handoff: scope-pr-auto-commit-to-affected-files

> Author: Codex | Spec: `tasks/scope-pr-auto-commit-to-affected-files/spec.md` | Plan: `tasks/scope-pr-auto-commit-to-affected-files/plan.md`
>
