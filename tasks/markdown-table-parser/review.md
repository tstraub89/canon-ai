...
- [markdown-table-parser] handoff→diff: tasks/markdown-table-parser/notes.md listed in handoff but not in diff
- [markdown-table-parser] handoff→diff: tasks/markdown-table-parser/review.md listed in handoff but not in diff
