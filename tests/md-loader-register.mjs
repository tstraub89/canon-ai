...
// Tests that import src/orchestrator/main.ts and call main() expect synchronous
...
// assert behavior. The auto-detach in src/orchestrator/detach.ts would respawn
